<template>
  <el-container class="main-layout">
    ...
    <el-footer>
      ...
      <a href="https://github.com/EmilyRosina/user-story-builder" target="_blank" rel="noopener" class="github">
        <icon name="brands/github" scale="2.5" title="Github Repository" />
      </a>
    </el-footer>
