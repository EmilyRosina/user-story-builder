<template>
  <el-dialog
    :title="`${mode} data group`"
    :visible="showModal"
    :width="modalWidth"
    :close-on-click-modal="false"
    @close="closeModal('dataGroupId')"
    :class="`${mode}-data-group`">
    ...
    <span slot="footer">
      <el-button v-if="mode === 'add'" plain @click="addDataGroup" type="success" :disabled="!validated" class="U--full-width">Add data group</el-button>
      <el-button v-if="mode === 'edit'" plain @click="saveDataGroup" type="success" :disabled="!validated" class="U--full-width">Save changes</el-button>
    </span>
    ...
    computed: {
      ...
      showModal () {
        return this.mode === 'add'
          ? this.active.modal === 'addDataGroup'
          : this.active.modal === 'editDataGroup'
      }
    }
  }
</script>
